...
def main():
        ...
        outFileName = sys.argv[6] # output .prof file
        R0 = float(sys.argv[2]) # width of the top-hat part 
        A0 = float(sys.argv[3]) # decay width of Gaussian 
        R1 = float(sys.argv[4]) # width of the top-hat part 
        A1 = float(sys.argv[5]) # decay width of Gaussian 
        ...
        Wrz = conv.CreeBonesConvolvedResponse(r, z, Arz, myIsp)
