...
% Keywords
\noindent{\it Keywords:} computational biophotonics, beam-profile convolution,
...
In the remainder we consider a paradigmatic problem in computational
biophotonics that requires a large number of polar convolutions, and,
consequently, many forward and reverse dFBTs. One might thus benefit from the
potential time-efficiency of the algorithmic procedure outlined in section
\ref{sec:dFBT} and assessed in section \ref{sec:examples}.  In procedural terms,
we provide a general solver for the problem of computing the material response
to radially symmetric custom laser beams of finite extend for layered
