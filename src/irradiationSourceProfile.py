...
def Gaussian(r,(R0,A0)=(0.,0.2)):
        ...
        Args:
            r (numpy array, ndim=1): Equispaced 1D grid for radial coordinate.
            A0 (float): 1/e-width of Gaussian (default: 0.2).

        Returns:
            f (numpy array, ndim=1): Gaussian beam profile.
        """
        return np.exp(-(r-R0)**2/A0/A0)
...
def flatTop(r, (R0,D0)=(0.5,0.05)):
        ...
        Args:
            ...
            D0 (float): 1/e-width of Gaussian (default: 0.05).
...
def donut(r, (R0,R1,D0,D1)=(0.5,0.7,0.1,0.1)):
        ...
        Args:
            ...
            D0 (float): 1/e-width of inner Gaussian (default: 0.1).
            D1 (float): 1/e-width of outer Gaussian (default: 0.1).
